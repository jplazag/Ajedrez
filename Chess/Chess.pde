...
ColButton[] butMA=new ColButton[9], butMN=new ColButton[9],promotion= new ColButton[5];
  ...
  for (int i=31; i<40; i++) {
    if (nivel==i) {
      ...
      case 0:
        ...
        break;
      case 1:
        aperturas.setInput(loadStrings(partida2));
        aperturas.lector();
        break;
      case 2:
        partida = "caballos.pgn";
        aperturas.setInput(loadStrings(partida));
        aperturas.lector();
        break;
      case 3:
        partida = "budapest.pgn";
        aperturas.setInput(loadStrings(partida));
        aperturas.lector();
        break;
      case 4:
      ...
      case 5:
        ...
        break;
      case 6:
        partida = "defindia.pgn";
        aperturas.setInput(loadStrings(partida));
        aperturas.lector();
        break;
      case 7:
        partida = "italiana.pgn";
        aperturas.setInput(loadStrings(partida));
        aperturas.lector();
        break;
      case 8:
        partida = "siciliana.pgn";
        aperturas.setInput(loadStrings(partida));
        aperturas.lector();
        break;
      }
  ...
  for (int i=41; i<50; i++) {
    if (nivel==i) {
      ...
      if (solAc==1) {
        ...
        switch(cambioPartida%9) {
        case 0:
          partida = "Solucion1.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        case 1:
          partida = "Solucion2.txt";
          aperturas.setInput(loadStrings(partida2));
          aperturas.lector();
          break;
        case 2:
          partida = "Solucion3.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        case 3:
          partida = "Solucion4.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        case 4:
          partida = "Solucion5.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        case 5:
          partida = "Solucion6.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        case 6:
          partida = "Solucion7.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        case 7:
          partida = "Solucion8.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        case 8:
          partida = "Solucion9.txt";
          aperturas.setInput(loadStrings(partida));
          aperturas.lector();
          break;
        }
